...
\begin{document}
    \begin{layout}
        ...
        \input{sections/05_integration_bi-variater_funktionen.tex}
        ...
        \input{sections/06_integration_multi-variater_funktionen.tex}
        % IGNORED: Fubini (Integration) -> iwie unnötig, da bereits im bi-variaten Fall beschrieben
        % TODO: Transformation / Jacobi
        \input{sections/07_diff_integration_kurven.tex}
        % TODO: Kurvenintegral 2. Art
        \input{sections/08_oberflaechenintegrale.tex}
        % TODO: Allgemeine Wendelfläche
        % TODO: Freie Fläche (parametrisiert)
        % TODO: 1. metrischer Tensor
        
        \input{sections/09_vektoranalysis.tex}
