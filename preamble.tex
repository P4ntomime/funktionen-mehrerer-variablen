...
\usepackage{tikz-3dplot}            % needed for TikZ 3D drawings
...
\DeclareMathOperator{\sgn}{sgn}     % create sgn operator
...
% custom command for scalar product
\newcommand*{\dotp}{\mathpalette\dotp@{.65}}
...
\NewDocumentEnvironment{layout}{}
                            ...
                            \begin{center}
                                ...
                                \normalfont\huge\semester\ -- \dozent{}\\[2mm]
                                \normalfont\Large Autoren:\\
                                \normalfont\Large\author{}\\[2mm]
